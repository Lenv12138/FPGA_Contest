...
HD_PWD='F:/FPGA_Contest_Proj/Con_proj_led/Con_proj_led.runs/CLK_400MHZ_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log CLK_400MHZ.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source CLK_400MHZ.tcl
