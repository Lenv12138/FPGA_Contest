...
HD_PWD='F:/FPGA_Contest_Proj/PPS/PPS.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pps_out2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source pps_out2.tcl
